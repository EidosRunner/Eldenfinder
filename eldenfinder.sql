...
(6, 2, 4, '2026-06-13 12:07:55'),
(7, 2, 5, '2026-06-17 12:58:32'),
(8, 2, 6, '2026-06-17 12:58:37');
...
CREATE TABLE `item` (
  ...
  `skill FP cost` int(11) DEFAULT NULL,
  `weight` decimal(10,0) DEFAULT NULL,
  `upgrade material` text DEFAULT NULL,
...
(9, 'grafted-blade-greatsword', 'Grafted Blade Greatsword', 'Colosse de métal forgé d\'innombrables épées entremêlées.', 'Épée géante obtenue en vainquant Leonine Misbegotten au Château Morne. L\'une des armes les plus lourdes du jeu. Son skill renforce temporairement toutes les statistiques du joueur.', NULL, 'published', NULL, NULL, 4, 1, 'Oath of Vengeance', 40, 21, 'Smithing Stone', 0),
...
--
ALTER TABLE `collection`
  ADD CONSTRAINT `collection_ibfk_1` FOREIGN KEY (`creator_id`) REFERENCES `operator` (`id`);
...
ALTER TABLE `item`
  ...
  ADD CONSTRAINT `item_ibfk_2` FOREIGN KEY (`theme_id`) REFERENCES `theme` (`id`);

--
-- Constraints for table `message`
--
ALTER TABLE `message`
  ADD CONSTRAINT `message_ibfk_1` FOREIGN KEY (`id`) REFERENCES `operator` (`id`);
...
--
ALTER TABLE `tagged`
  ADD CONSTRAINT `tagged_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`),
  ADD CONSTRAINT `tagged_ibfk_2` FOREIGN KEY (`tag_id`) REFERENCES `tag` (`id`);
COMMIT;
