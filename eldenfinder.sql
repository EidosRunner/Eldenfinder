...
--
-- Host: localhost:3306
-- Generation Time: Apr 10, 2026 at 02:47 PM
...
(2, 'dog', 'turtle', NULL, NULL, NULL, 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `item`
  ADD CONSTRAINT `item_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `theme` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
